...
販売サイト
https://pikarikbd.booth.pm/items/4799710

プロトタイプ版(v0.1)は https://github.com/goropikari/miniEC/tree/prototype をご参照ください。
...
| スイッチ        | 36キー分 | 使用できるスイッチに関しては「[動作確認済みスイッチ](docs/switch.md)」をご参照ください |
...
![表](docs/img/omote.png)

![裏](docs/img/ura.png)

### ProMicro・TRRS ジャック・タクトスイッチのハンダ付け
写真のように ProMicro、TRRS ジャック、タクトスイッチを配置しハンダ付けします。

![はんだ付け](docs/img/handa.png)
...
![niz_switch](docs/img/niz_switch.png)


ハウジングを全て嵌めたらプランジャーをハウジングに入れていきます。プランジャーはハウジングのレールに沿うように入れてください。

正しい向き<br>
![軸](docs/img/axis_correct.jpg)

間違った向き<br>
![軸](docs/img/axis_wrong.jpg)
...
![topre switch](docs/img/topre_switch.png)
...
![ラバーシート写真](docs/img/rubber_sheet.jpg)

(オプション) ラバーシートの側面に穴を開けると打鍵が軽くなります。一方でタクタイル感が減りリニアに違い打鍵感になります。

![穴を開けたラバーシート写真](docs/img/rubber_sheet_hole.jpg)
...
![spring](docs/img/spring.png)

プランジャーが落ちきった状態で作業をする。

![stand](docs/img/stand.png)

### ProMicro カバー

左右用のカバーが一つの基板として連結しているので切り離し、バリをヤスリで削ってください。

![promicro cover](docs/img/cover.png)


PCB に M2 8 mm スペーサーを取り付け、カバーをネジで固定してください。

![](docs/img/cover_spacer.png)
...
![m4 spacer](docs/img/m4_spacer.png)

![bottom plate](docs/img/bottom.png)
