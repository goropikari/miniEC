...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DEFAULT] = LAYOUT(
        ...
        KC_Z        , KC_X     , KC_C     , KC_V                 , KC_B    ,                KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  ,
                          RGUI_T(KC_ESC)  , LT(_LOWER, KC_MINS)  , KC_CTLTB,      LT(_RAISE, KC_ENT) , KC_MT_SS , KC_LALT
    ),
    ...
    [_LOWER] = LAYOUT(
        ...
        XXXXX       , XXXXX    , XXXXX    , XXXXX                , XXXXX   ,               KC_END    , KC_ENT   , KC_LBRC  , KC_RBRC  , KC_DEL   ,
                                 KC_RGUI  , LOWER                , KC_CTLTB,               ADJUST    , KC_MT_SS , KC_LALT
    ),
    ...
    [_RAISE] = LAYOUT(
        ...
        KC_LCTL     , KC_LSFT  , XXXXX    , XXXXX                , XXXXX   ,                KC_ENT   , KC_PLUS  , KC_TILD  , XXXXX    , KC_RSFT     ,
                                 KC_RGUI  , ADJUST               , KC_CTLTB,                XXXXX    , XXXXX    , KC_LALT
    ),
